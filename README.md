...
- 🍔 빅맥 지수(Big Mac index)란?
  ...
  - 국가 간 경제력을 비교하거나 소비 수준을 분석하는 데 유용합니다.
...
- 빅맥지수는 각국의 빅맥 햄버거 가격을 미국에서의 가격과 같게 만들어주는 환율을 의미
...
### 📊 Kibana 시각화
- 한국 빅맥지수 (미국 기준)
  ![image](https://github.com/user-attachments/assets/14f3efae-3f86-4aee-8eaa-3905ef218322)
  - 빅맥 지수가 지속적으로 떨어지는 것을 확인할 수 있다.
  - 빅맥지수가 낮다 → 환율이 높다 → 대한민국 화폐 가치 낮게 평가
- 년도별 대한민국 빅맥 가격 (달러로 변환)
  ![image1](https://github.com/user-attachments/assets/b792876e-e212-43b0-8e70-52809774447c)

- 한국과 미국 빅맥 가격
  ![image2](https://github.com/user-attachments/assets/15a70459-2d27-4e41-9c6c-9cd84d7fd176)

- 한달 최저임금으로 구매할 수 있는 빅맥 개수
  - 2000년~2018년 평균
    ![image3](https://github.com/user-attachments/assets/4c252135-4ca0-4c2f-b99f-b11d88372415)
    - 2000년~2018년까지 월 최저 임금으로 구입할 수 있는 빅맥 수를 비교해봤을 때, 한국과 미국이 비슷한 것을 확인할 수 있다.
    - 현지인 입장에서 빅맥 가격은 비슷하다고 결론을 내릴 수 있다.
  - 2018년 기준
    ![image4](https://github.com/user-attachments/assets/6767a8a2-daaf-4f1b-80fc-424f6d3ed0dd)
    - 2018년 데이터만으로 봤을 때, 한국 수치가 미국보다 높은 것을 확인할 수 있다.
    - why?
      미국은 2009년부터 15년동안 최저임금이 동결되었다. 또한, 미국은 팁의 수익이 높기 때문에 확실한 분석을 위해서는 최저임금이 아닌 평균 수입으로 비교해야 했다.
