...
## 🌍 프로젝트 개요 
본 프로젝트는 Ubuntu 환경에서 Logstash를 활용해 MySQL과 ElasticSearch를 연동하고, Kibana를 활용한 시각화를 통해 나라별 빅맥 지수와 최저 임금, 관광 데이터 간의 유의미한 인사이트 도출을 목표로 한다. 
